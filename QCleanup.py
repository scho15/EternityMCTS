				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 115, 193, 194, 240, 81, 26, 14, 88, 214, 140, 138, 159, 200, 106, 127, 111, 120, 154, 149")):
								comment = "46: 4 18...127 111 120 154 149 NEW AREA"
								newmin = 0
								...
								comment = "44: 4 18...200 106 127 111 120 min 202"
								newmin = 202
								...
								comment = "38: 4 18...14 88 214 140 138 min 204"
								newmin = 204
								...
								comment = "36: 4 18...81 26 14 88 214 min 203"
								newmin = 203
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 115, 193, 194, 240, 81, 26, 14, 88, 113")):
								comment = "35+: 4 18...240 81 26 14 88 + 113 min 205"
								newmin = 205
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 115, 193, 194, 240, 81, 26, 14, 88, 217")):
								comment = "35+: 4 18...240 81 26 14 88 + 217 min 203"
								newmin = 203
								...
								comment = "34: 4 18...194 240 81 26 14 min 205"
								newmin = 205
								...
								comment = "33+: 4 18...193 194 240 81 26 + 10 min 204"
								newmin = 204
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 115, 193, 194, 240, 81, 26, 47")):
								comment = "33+: 4 18...193 194 240 81 26 + 47 min 204"
								newmin = 204
								...
								comment = "33+: 4 18...193 194 240 81 26 + 54 min 203"
								newmin = 203
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 115, 193, 194, 240, 81, 26, 21")):
								comment = "33+: 4 18...193 194 240 81 26 + 21 min 203"
								newmin = 203
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 115, 193, 194, 240, 81, 26, 34")):
								comment = "33+: 4 18...193 194 240 81 26 + 34 min 204"
								newmin = 204
								...
								comment = "33: 4 18...193 194 240 81 26 min 205"
								newmin = 205
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 156")):
								comment = "27+: 4 18...180 162 89 104 102 + 156 min 205"
								newmin = 205
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102")):
								comment = "27: 4 18...180 162 89 104 102 min 206"
								newmin = 206
								...
								comment = "24: 4 18...118 131 122 180 162 min 207"
								newmin = 207
								...
								newmin = 208
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 211")):
								comment = "22+: 4 18...44 77 118 131 122 + 211 min 205"
								newmin = 205
								...
								newmin = 207
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 60")):
								comment = "17+: 4 18...45 9 32 31 3 + 60 min 205"
								newmin = 205
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3")):
								comment = "17: 4 18...45 9 32 31 3 min 206"
								newmin = 206
								...
								newmin = 205
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 33")):
								comment = "14+: 4 18...28 35 53 45 9 + 33 min 205"
								newmin = 205
								...
								newmin = 205
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 12")):
								comment = "13+: 4 18...27 28 35 53 45 + 12 min 205"
								newmin = 205
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45")):
								comment = "13: 4 18...27 28 35 53 45 min 206"
								newmin = 206
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 40")):
								comment = "12+: 4 18...16 27 28 35 53 + 40 min 205"
								newmin = 205
								...
								newmin = 205
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 21")):
								comment = "6+: 4 18 51 15 6 + 21 min 205"
								newmin = 205
							elif (fullmatch.startswith("[4, 18, 51, 15, 6")):
								comment = "6: 4 18 51 15 6 min 206"
								newmin = 206
							elif (fullmatch.startswith("[4, 18, 51, 15, 5")):
								comment = "5+: 4 18 51 15 + 5 min 205"
								newmin = 205
...
#QCleanup.rangeReader(0,50,211,True)
#QCleanup.reader(96,205,True)
#QCleanup.reader(46,1,True,"[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 115, 193, 194, 240, 81, 26, 14, 88, 214, 140, 138, 159, 200, 106, 127, 111, 120, 154, 149")
#QCleanup.reader(25,1,True,"[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89")
#QCleanup.reader(5,1,True,"[4, 18, 51, 15")
#QCleanup.table(180)
#QCleanup.viewer()
#QCleanup.viewCounter(500000)
#QCleanup.updateFrom96(217)
# True indicates using new minimum function which only shows iterations that need updating
QCleanup.runParser(500000,1,199,True,7000) 