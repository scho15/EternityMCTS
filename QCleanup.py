				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[4, 16, 28, 31, 25, 13, 52, 5, 11, 15, 8, 60, 35, 58, 51, 3, 56, 160, 131, 192, 126, 179, 138, 66, 196, 134, 108, 120, 230, 130, 63, 27, 23, 203, 165, 114, 115, 110, 148, 145, 140, 172, 247, 173, 73, 69, 222, 36, 43, 226, 70, 113, 158, 123, 150, 83, 99, 175, 164, 159, 170, 154, 254, 53")):
								comment = "213 Sequence: 5 11 ... 36 43 ... 159 170 154 254 53 NEW AREA"
								newmin = 0
							elif (fullmatch.startswith("[4, 16, 28, 31, 25, 13, 52, 5, 11, 15, 8, 60, 35, 58, 51, 3, 56, 160, 131, 192, 126, 179, 138, 66, 196, 134, 108, 120, 230, 130, 63, 27, 23, 203, 165, 114, 115, 110, 148, 145, 140, 172, 247, 173, 73, 69, 222, 36, 43, 226, 70, 113, 158, 123, 150, 83, 99, 175, 164, 159, 170, 154, 254")):
								comment = "213 Sequence: 5 11 ... 36 43 ... 164 159 170 154 254 min 190"
								newmin = 190
								...
								comment = "213 Sequence: 5 11 ... 36 43 ... 99 175 164 159 170 min 189"
								newmin = 189
								...
								comment = "213 Sequence: 5 11 ... 36 43 ... 150 83 99 175 164 min 200"
								newmin = 200
								...
								comment = "213 Sequence: 5 11 ... 36 43 ... 123 150 83 99 175 min 201"
								newmin = 201
								...
								comment = "213 Sequence: 5 11 ... 36 43 226 70 113 min 205"
								newmin = 205
								...
								comment = "213 Sequence: 5 11 ... 36 43 226 min 206"
								newmin = 206
								...
								comment = "213 Sequence: 5 11 ... 58 51 3 ... 145 140 172 247 173 73 min 207"
								newmin = 207
								...
								newmin = 204
							elif (match.startswith("[4, 16, 28, 31, 25, 13, 60")):
								comment = "213 Sequence: Early 4 16 28 31 25 13 60 min 205"
								newmin = 205
...
#QCleanup.rangeReader(0,66,210,True)
#QCleanup.reader(57,1,True,"[4, 16, 28, 31, 25, 13, 52, 5, 11, 15, 8, 60, 35, 58, 51, 3, 56, 160, 131, 192, 126, 179, 138, 66, 196, 134, 108, 120, 230, 130, 63, 27, 23, 203, 165, 114, 115, 110, 148, 145, 140, 172, 247, 173, 73, 69, 222, 36, 43, 226, 70, 113, 158, 123, 150, 83")
...
QCleanup.runParser(650000,1,270,True,15795) 
