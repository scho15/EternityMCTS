				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83")):
								comment = "55: 2 42 10 ... 108 165 212 210 83 NEW AREA"
								newmin = 0
								...
								comment = "53: 2 42 10 ... 36 31 108 165 212 min 204"
								newmin = 204
								...
								comment = "49: 2 42 10 ... 219 226 123 239 36 + 51 min 204"
								newmin = 204
								...
								comment = "49: 2 42 10 ... 219 226 123 239 36 min 206"
								newmin = 206
								...
								comment = "33: 2 42 10 ... 235 244 192 81 16 min 206"
								newmin = 206
...
#QCleanup.rangeReader(0,57,211,True)
...
#QCleanup.reader(4,1,True,"[2, 42, 10")
#QCleanup.table(180)
#QCleanup.viewer()
...
QCleanup.runParser(550000,1,249,True,9991) 