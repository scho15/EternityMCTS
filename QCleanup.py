				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[4, 16, 28, 31, 25, 13, 52, 5, 11, 15, 8, 60, 35, 58, 51, 3, 56, 160, 131, 192, 126, 179, 138, 66, 196, 134, 108, 120, 230, 130, 63, 27, 23, 203, 165, 114, 115, 110, 148, 145, 140, 172, 247, 173, 73, 69, 222, 36, 43, 226, 70, 113, 158, 123, 150, 83, 99, 175, 164, 159, 170, 154, 254, 48, 53")):
								comment = "213 Sequence: 5 11 ... 36 43 ... 170 154 254 48 53 NEW AREA"
								newmin = 0
								...
								comment = "213 Sequence: 5 11 ... 36 43 ... 99 175 164 159 170 min 202"
								newmin = 202
...
#QCleanup.rangeReader(0,66,211,True)
#QCleanup.reader(65,1,True,"[4, 16, 28, 31, 25, 13, 52, 5, 11, 15, 8, 60, 35, 58, 51, 3, 56, 160, 131, 192, 126, 179, 138, 66, 196, 134, 108, 120, 230, 130, 63, 27, 23, 203, 165, 114, 115, 110, 148, 145, 140, 172, 247, 173, 73, 69, 222, 36, 43, 226, 70, 113, 158, 123, 150, 83, 99, 175, 164, 159, 170, 154, 254, 48")
#QCleanup.reader(51,1,True,"[4, 16, 28, 31, 25, 13, 52, 5, 11, 15, 8, 60, 35, 58, 51, 3, 56, 160, 131, 192, 126, 179, 138, 66, 196, 134, 108, 120, 230, 130, 63, 27, 23, 203, 165, 114, 115, 110, 148, 145, 140, 172, 247, 173, 73, 69, 222, 36, 43, 226")
#QCleanup.reader(88,205,True)
#QCleanup.reader(7,1,True,"[4, 16, 28, 31, 25, 13")
#QCleanup.table(180)
#QCleanup.viewer()
#QCleanup.cleanser()
#QCleanup.viewCounter(650000)
# True indicates using new minimum function which only shows iterations that need updating
QCleanup.runParser(650000,1,304,True,16295) 
