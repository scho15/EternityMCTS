				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102")):
								comment = "67: 2 42 10 ... 135 211 48 28 102 NEW AREA"
								newmin = 0
								...
								comment = "66: 2 42 10 ... 246 135 211 48 28 + 63 min 201"
								newmin = 201
								...
								comment = "66: 2 42 10 ... 246 135 211 48 28 min 204"
								newmin = 204
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 9")):
								comment = "65: 2 42 10 ... 246 135 211 48 + 9 min 203"
								newmin = 203
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 41")):
								comment = "65: 2 42 10 ... 246 135 211 48 + 41 min 204"
								newmin = 204
								...
								comment = "61: 2 42 10 ... 64 126 168 141 160 min 206"
								newmin = 206
								...
								comment = "60: 2 42 10 ... 84 64 126 168 141 min 206"
								newmin = 206
...
#QCleanup.rangeReader(0,75,211,True)
#QCleanup.reader(16,205,True)
#QCleanup.reader(54,1,True,"[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210")
...
QCleanup.runParser(600000,1,300,True,13000) 