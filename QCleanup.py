				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[4, 16, 28, 31, 25, 13, 52, 5, 11, 15, 8, 60, 35, 58, 51, 3, 56, 160, 131, 192, 126, 179, 138, 66, 196, 134, 108, 120, 230, 130, 63, 27, 23, 203, 165, 114, 115, 110, 148, 145, 140, 172, 247, 173, 73, 69, 222, 36, 43, 226")):
								comment = "213 Sequence: 5 11 ... 58 51 3 ... 73 69 222 36 43 226 NEW AREA"
								newmin = 0
								...
								comment = "213 Sequence: 5 11 ... 58 51 3 ... 173 73 69 222 36 43 min 189"
								newmin = 189
								...
								comment = "213 Sequence: 5 11 ... 58 51 3 ... 247 173 73 69 222 36 min 196"
								newmin = 196
...
#QCleanup.rangeReader(0,51,210,True)
...
QCleanup.runParser(600000,1,229,True,13787) 
