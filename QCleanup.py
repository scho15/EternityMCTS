				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 34, 37, 2, 32, 240, 120, 136, 124, 243, 146, 71, 102, 113, 236, 251, 75, 98, 158, 48, 56, 201, 253, 143, 89, 77, 151, 154, 164, 213, 228, 135, 129, 97, 70, 38")):
								comment = "49: 4 18...135 129 97 70 38 NEW AREA"
								newmin = 0
								...
								comment = "44: 4 18...151 154 164 213 228 min 203"
								newmin = 203
								...
								comment = "43: 4 18...77 151 154 164 213 min 203"
								newmin = 203
							elif (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 34, 37, 2, 32, 240, 120, 136, 124, 243, 146, 71, 102, 113, 236, 251, 75, 98, 158, 48, 56, 201, 253, 143, 89, 77, 151, 154, 164, 145")):
								comment = "42+: 4 18...89 77 151 154 164 + 145 min 203"
								newmin = 203
								...
								comment = "40: 4 18...253 143 89 77 151 min 205"
								newmin = 205
								...
								comment = "39+: 4 18...201 253 143 89 77 + 84 min 205"
								newmin = 205
								...
								comment = "38+: 4 18...56 201 253 143 89 + 76 min 204"
								newmin = 204
...
#QCleanup.reader(38,1,True,"[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 34, 37, 2, 32, 240, 120, 136, 124, 243, 146, 71, 102, 113, 236, 251, 75, 98, 158, 48, 56, 201, 253, 143, 89")
#QCleanup.reader(29,1,True,"[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 34, 37, 2, 32, 240, 120, 136, 124, 243, 146, 71, 102, 113, 236, 251")
...
#QCleanup.runParser(600000,1,189,True,12960) 