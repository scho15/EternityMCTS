				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140, 131, 67, 154, 255, 197, 198, 159, 150, 180, 71, 88, 72, 205, 57")):
								comment = "96+: 2 42 10 ... 159 150 180 71 88 72 205 57 COMPLETE"
								newmin = 215
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140, 131, 67, 154, 255, 197, 198, 159, 150, 180, 71, 88, 72, 205")):
								comment = "96: 2 42 10 ... 159 150 180 71 88 72 205 min 206"
								newmin = 206
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140, 131, 67, 154, 255, 197, 198, 159, 150, 180, 71")):
								comment = "93: 2 42 10 ... 198 159 150 180 71 min 206"
								newmin = 206
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140, 131, 67, 154, 255, 197, 198, 159")):
								comment = "90: 2 42 10 ... 154 255 197 198 159 min 202"
								newmin = 202
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140, 131, 67, 154, 255, 197, 198")):
								comment = "89: 2 42 10 ... 67 154 255 197 198 min 205"
								newmin = 205
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140, 131, 67")):
								comment = "85: 2 42 10 ... 38 29 140 131 67 min 206"
								newmin = 206
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140, 131")):
								comment = "84: 2 42 10 ... 70 38 29 140 131 min 204"
								newmin = 204
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140, 99")):
								comment = "83: 2 42 10 ... 82 70 38 29 140 + 99 min 203"
								newmin = 203
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140")):
								comment = "83: 2 42 10 ... 82 70 38 29 140 min 206"
								newmin = 206
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 143")):
								comment = "82: 2 42 10 ... 162 82 70 38 29 + 143 min 205"
								newmin = 205
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29")):
								comment = "82: 2 42 10 ... 162 82 70 38 29 min 206"
								newmin = 206
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38")):
								comment = "81: 2 42 10 ... 200 162 82 70 38 min 204"
								newmin = 204
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 93")):
								comment = "76: 2 42 10 ... 185 76 250 109 128 + 93 min 204"
								newmin = 204
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128")):
								comment = "76: 2 42 10 ... 185 76 250 109 128 min 206"
								newmin = 206
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250")):
								comment = "74: 2 42 10 ... 171 177 185 76 250 min 205"
								newmin = 205
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177")):
								comment = "71: 2 42 10 ... 102 201 230 171 177 min 207"
								newmin = 207
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230")):
								comment = "69: 2 42 10 ... 48 28 102 201 230 min 205"
								newmin = 205
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102")):
								comment = "67: 2 42 10 ... 135 211 48 28 102 min 207"
								newmin = 207
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28")):
								comment = "66: 2 42 10 ... 246 135 211 48 28 min 207"
								newmin = 207
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48")):
								comment = "65: 2 42 10 ... 160 246 135 211 48 min 205"
								newmin = 205
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135")):
								comment = "63: 2 42 10 ... 168 141 160 246 135 min 207"
								newmin = 207
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246")):
								comment = "62: 2 42 10 ... 126 168 141 160 246 min 210"
								newmin = 210
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160")):
								comment = "61: 2 42 10 ... 64 126 168 141 160 min 207"
								newmin = 207
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141")):
								comment = "60: 2 42 10 ... 84 64 126 168 141 min 208"
								newmin = 208
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 107")):
								comment = "59: 2 42 10 ... 83 84 64 126 168 + 107 min 206"
								newmin = 206
								...
								comment = "59: 2 42 10 ... 83 84 64 126 168 min 208"
								newmin = 208
								...
								comment = "58: 2 42 10 ... 210 83 84 64 126 min 206"
								newmin = 206
								...
								comment = "57: 2 42 10 ... 212 210 83 84 64 min 208"
								newmin = 208
								...
								comment = "56: 2 42 10 ... 165 212 210 83 84 min 206"
								newmin = 206
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210")):
								comment = "54: 2 42 10 ... 31 108 165 212 210 min 211"
								newmin = 211
								...
								comment = "53: 2 42 10 ... 36 31 108 165 212 min 207"
								newmin = 207
								...
								comment = "51: 2 42 10 ... 123 239 36 31 108 min 211"
								newmin = 211
								...
								comment = "46: 2 42 10 ... 119 182 138 219 226 min 212"
								newmin = 212
								...
								comment = "45: 2 42 10 ... 85 119 182 138 219 min 208"
								newmin = 208
								...
								comment = "43: 2 42 10 ... 248 203 85 119 182 min 207"
								newmin = 207
								...
								comment = "38: 2 42 10 ... 18 237 249 240 77 min 212"
								newmin = 212
								...
								comment = "14: 2 42 10 ... 21 45 12 + 48 min 206"
								newmin = 206
