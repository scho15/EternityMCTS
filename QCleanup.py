				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28")):
								comment = "66: 2 42 10 ... 246 135 211 48 28 NEW AREA"
								newmin = 0
								...
								comment = "65: 2 42 10 ... 160 246 135 211 48 min 198"
								newmin = 198
								...
								comment = "63: 2 42 10 ... 168 141 160 246 135 min 205"
								newmin = 205
								...
								comment = "61: 2 42 10 ... 64 126 168 141 160 min 203"
								newmin = 203
...
#QCleanup.rangeReader(0,67,211,True)
#QCleanup.reader(96,205,True)
#QCleanup.reader(65,1,True,"[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48")
...
#QCleanup.runParser(550000,1,292,True,12000) 