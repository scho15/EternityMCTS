				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 115, 193, 194, 240, 81, 26, 14, 88, 214, 140, 138, 159, 200, 106, 127, 111, 120, 154, 149, 173, 141, 25, 22, 85, 205, 161, 217, 74, 168, 170, 234")):
								comment = "58: 4 18...217 74 168 170 234 NEW AREA"
								newmin = 0
								...
								comment = "56: 4 18...205 161 217 74 168 min 203"
								newmin = 203
								...
								comment = "54: 4 18...22 85 205 161 217 min 202"
								newmin = 202
								...
								comment = "51: 4 18...173 141 25 22 85 min 204"
								newmin = 204
								...
								comment = "49+: 4 18...154 149 173 141 25 + 24 min 205"
								newmin = 205
								...
								comment = "49+: 4 18...154 149 173 141 25 + 5 min 205"
								newmin = 205
...
#QCleanup.reader(58,1,True,"[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 115, 193, 194, 240, 81, 26, 14, 88, 214, 140, 138, 159, 200, 106, 127, 111, 120, 154, 149, 173, 141, 25, 22, 85, 205, 161, 217, 74, 168, 170, 234")
#QCleanup.reader(54,1,True,"[4, 18, 51, 15, 6, 19, 16, 27, 28, 35, 53, 45, 9, 32, 31, 3, 44, 77, 118, 131, 122, 180, 162, 89, 104, 102, 115, 193, 194, 240, 81, 26, 14, 88, 214, 140, 138, 159, 200, 106, 127, 111, 120, 154, 149, 173, 141, 25, 22, 85, 205, 161, 217")
...
QCleanup.runParser(500000,1,249,True,9000) 