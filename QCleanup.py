				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138")):
								comment = "44: 2 42 10 ... 203 85 119 182 138 NEW AREA"
								newmin = 0
								...
								comment = "43: 2 42 10 ... 248 203 85 119 182 min 203"
								newmin = 203
								...
								comment = "42: 2 42 10 ... 77 248 203 85 119 min 205"
								newmin = 205
								...
								comment = "41: 2 42 10 ... 240 77 248 203 85 min 206"
								newmin = 206
								...
								comment = "39: 2 42 10 ... 237 249 240 77 248 min 206"
								newmin = 206
								...
								comment = "35: 2 42 10 ... 192 81 16 18 237 min 205"
								newmin = 205
								...
								comment = "27: 2 42 10 ... 105 247 104 127 206 min 206"
								newmin = 206
...
#QCleanup.reader(43,1,True,"[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182")
#QCleanup.reader(21,1,True,"[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174")
#QCleanup.table(180)
#QCleanup.viewer()
...
QCleanup.runParser(500000,1,199,True,7894) 