				...
				while line != "":	
					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165")):
								comment = "52: 2 42 10 ... 239 36 31 108 165 NEW AREA"
								newmin = 0
								...
								comment = "49: 2 42 10 ... 219 226 123 239 36 + 51 min 203"
								newmin = 203
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 26")):
								comment = "49: 2 42 10 ... 219 226 123 239 36 + 26 min 202"
								newmin = 202
								...
								comment = "49: 2 42 10 ... 219 226 123 239 36 min 204"
								newmin = 204
								...
								comment = "46: 2 42 10 ... 119 182 138 219 226 min 206"
								newmin = 206
								...
								newmin = 207
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 141")):
								comment = "43: 2 42 10 ... 248 203 85 119 182 + 141 min 204"
								newmin = 204
								...
								comment = "42: 2 42 10 ... 77 248 203 85 119 min 207"
								newmin = 207
								...
								comment = "41: 2 42 10 ... 240 77 248 203 85 min 207"
								newmin = 207
								...
								comment = "33: 2 42 10 ... 235 244 192 81 16 min 205"
								newmin = 205
								...
								comment = "27: 2 42 10 ... 105 247 104 127 206 min 207"
								newmin = 207
								...
								comment = "21: 2 42 10 ... 52 173 243 174 min 207"
								newmin = 207
								...
								newmin = 206
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 39")):
								comment = "14: 2 42 10 ... 21 45 12 + 39 min 206"
								newmin = 206
								...
								comment = "10: 2 42 10 ... 20 15 8 + 58 min 204"
								newmin = 204
								...
								newmin = 206
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 19")):
								comment = "8: 2 42 10 43 24 6 20 + 19 min 205"
								newmin = 205
...
QCleanup.reader(49,1,True,"[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36")
...
#QCleanup.runParser(500000,1,219,True,9000) 