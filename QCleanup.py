					...
					if line.startswith("The lookahead"):
						...
						if nextline.startswith("Shortened"):
							...
							if (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140, 131")):
								comment = "84: 2 42 10 ... 70 38 29 140 131 NEW AREA"
								newmin = 0
								...
								comment = "83: 2 42 10 ... 82 70 38 29 140 min 199"
								newmin = 199
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29")):
								comment = "82: 2 42 10 ... 162 82 70 38 29 min 201"
								newmin = 201
							elif (fullmatch.startswith("[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38")):
								comment = "81: 2 42 10 ... 200 162 82 70 38 min 202"
								newmin = 202
								...
								comment = "74: 2 42 10 ... 171 177 185 76 250 min 204"
								newmin = 204
...
#QCleanup.rangeReader(0,86,211,True)
#QCleanup.reader(96,205,True)
#QCleanup.reader(83,1,True,"[2, 42, 10, 43, 24, 6, 20, 15, 8, 59, 21, 45, 12, 44, 27, 4, 52, 173, 243, 174, 68, 105, 247, 104, 127, 206, 151, 235, 244, 192, 81, 16, 18, 237, 249, 240, 77, 248, 203, 85, 119, 182, 138, 219, 226, 123, 239, 36, 31, 108, 165, 212, 210, 83, 84, 64, 126, 168, 141, 160, 246, 135, 211, 48, 28, 102, 201, 230, 171, 177, 185, 76, 250, 109, 128, 200, 162, 82, 70, 38, 29, 140")
#QCleanup.reader(10,1,True,"[2, 42, 10, 43, 24, 6, 20, 15, 8")
#QCleanup.table(180)
#QCleanup.viewer()
...
#QCleanup.runParser(600000,1,380,True,15000) 